...
urlpatterns = [
    ...
    path('events/<int:eventID>/participation-deeds/attach/<int:deedID>/', views.attach_deed_view, name='attach'),
    path('participation-deeds/<int:deedID>/delete/', views.delete_unattached_deed, name='delete'),
